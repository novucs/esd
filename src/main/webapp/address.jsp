...
<div class="container">
    <div class="row">
        <div id="address-component-container" class="col s6 push-s3 rounded-container">
            ...
            <div class="row">
                <form method="post"
                      action="${pageContext.request.contextPath}/api/addressLookup.do">
                    ...
                    <div class="col s12">
                        <div class="row">
                            <div class="col s4">
                                <div class="input-field">
                                    <input name="houseno" id="houseno" type="text"
                                           value="<%=request.getParameter("houseno")%>"
                                           required/>
                        ...
                        <% for (String address : (List<String>) request
                                .getAttribute("addressData")) { %>
                        <%=address%><br/>
                        <% } %>
                        <% } %>
                    </div>
