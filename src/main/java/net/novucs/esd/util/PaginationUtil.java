...
public class PaginationUtil {
 ...
 public static String[] pageSizes = {"1", "2", "3"};
  ...
  public static <M> List<M> paginate(Dao<M> dao, int pageSize, double pageNumber)  throws SQLException {
  ...
  public static void setRequestAttributes(HttpServletRequest request, int maxPages, double pageNumber,
      int pageSize){
